...
registerOnClick('LLANTA INICIO', false, false, [0,1,2], false, function(event) {
    zoomCamera('CARRO1', 1, function() {});
}, function(event) {});
registerOnClick('LLANTA INICIO', false, false, [0,1,2], false, function(event) {
    zoomCamera('PLANETATV', 1, function() {});
}, function(event) {});
registerOnClick('PLANETATV', false, false, [0,1,2], false, function(event) {
    tweenCamera('camara 1', 'cmara lockup1', 2, function() {}, 1);
}, function(event) {});
registerOnClick('EDIFICIO', false, false, [0,1,2], false, function(event) {
    tweenCamera('camara 2', 'cmara lockup2', 2, function() {}, 1);
}, function(event) {});
registerOnClick('FLOR', false, false, [0,1,2], false, function(event) {
    zoomCamera('CASITA', 1, function() {});
}, function(event) {});
registerOnClick('CASITA', false, false, [0,1,2], false, function(event) {
    zoomCamera('BOTELLA', 1, function() {});
}, function(event) {});
registerOnClick('BOTELLA', false, false, [0,1,2], false, function(event) {
    tweenCamera('camara 3.001', 'cmara lockup3.001', 2, function() {}, 1);
}, function(event) {});
registerOnClick('JAMONCIN', false, false, [0,1,2], false, function(event) {
    tweenCamera('camara 4.002', 'cmara lockup4.002', 2, function() {}, 1);
}, function(event) {});
